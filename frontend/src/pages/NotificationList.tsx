...
export const NotificationList = () => {
  ...
  return (
    <Layout>
      <PageShell width="default" padding="md">
        <PageHeader
          ...
          actions={
            <>
              <Link to="/" className={cn(getButtonClassName({ variant: 'secondary' }), 'w-full sm:w-auto')}>
        ...
        <Panel className="mb-6" padding="sm" variant="muted">
          <SegmentedControl
            value={filterType}
                  ...
                  <article>
                    <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-start sm:justify-between">
                      <div className="flex min-w-0 gap-4">
                        ...
                        >
                          {notif.is_read ? <MailOpen className="h-5 w-5" /> : <Mail className="h-5 w-5" />}
                        </div>
                        <div className="min-w-0">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            {!notif.is_read && (
                              <span className="rounded-full bg-primary-50 px-2.5 py-1 text-xs font-semibold text-primary-600 dark:bg-primary-500/10 dark:text-primary-300">
                      ...
                      <div className="flex shrink-0 flex-wrap items-center gap-2">
                        ...
                        {!notif.is_read && (
                          <Button type="button" size="sm" onClick={() => handleMarkRead(notif.id)}>
