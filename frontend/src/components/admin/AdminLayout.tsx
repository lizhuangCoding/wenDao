...
export const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { name: '标签', path: '/admin/tags', icon: 'M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.169.659 1.591l9.682 9.682a2.25 2.25 0 003.182 0l4.318-4.318a2.25 2.25 0 000-3.182L11.16 3.659A2.25 2.25 0 009.568 3zM6.75 6.75h.008v.008H6.75V6.75z' },
