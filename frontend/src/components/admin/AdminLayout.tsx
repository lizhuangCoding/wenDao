...
export const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { name: '用户管理', path: '/admin/users', icon: 'M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z' },
    ...
    { name: '消息广播', path: '/admin/broadcast', icon: 'M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z' },
    { name: '站点设置', path: '/admin/settings', icon: 'M11.42 15.17l7.25-7.25m0 0l-7.25 7.28m7.25-7.28L15.59 4.81m3.08 3.11L22 11.42M6.75 3.5A3.25 3.25 0 003.5 6.75v10.5A3.25 3.25 0 006.75 20.5h10.5a3.25 3.25 0 003.25-3.25V13' },
  ];
