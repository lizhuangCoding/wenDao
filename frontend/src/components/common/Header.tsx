            ...
            <div className="mt-5">
              {isAuthenticated ? (
                <button
                  type="button"
                  onClick={handleLogout}
                  className="w-full rounded-2xl border border-red-100 px-4 py-3 text-xs font-black tracking-widest text-red-500 transition-colors hover:bg-red-50 dark:border-red-900/40 dark:hover:bg-red-950/30"
                >
                  {t('nav.logout')}
                </button>
              ) : (
