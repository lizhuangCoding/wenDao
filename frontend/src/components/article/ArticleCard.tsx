      ...
      <article className="flex flex-col h-full">
        <div className="relative aspect-[16/10] mb-6 overflow-hidden rounded-2xl bg-neutral-100 shadow-soft transition-all duration-500 group-hover:shadow-elevated group-hover:-translate-y-1 dark:bg-neutral-800 sm:mb-8">
          {article.cover_image ? (
            ...
            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-neutral-50 to-neutral-100 text-neutral-200 dark:from-neutral-800 dark:to-neutral-900 dark:text-neutral-600">
        ...
        <div className="flex flex-col flex-1">
          ...
          <footer className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between pt-6 border-t border-neutral-200 dark:border-neutral-700">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-neutral-300 dark:text-neutral-500">
              ...
              <div className="w-1 h-1 bg-neutral-200 rounded-full dark:bg-neutral-700"></div>
              <div className="flex items-center gap-1.5">
