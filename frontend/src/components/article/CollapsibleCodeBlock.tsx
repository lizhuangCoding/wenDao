  ...
  return (
    <div className="relative my-8">
      <pre
        {...props}
        className={cn(
          'relative m-0 overflow-x-auto rounded-2xl border border-neutral-800 bg-neutral-950 p-5 text-sm leading-7 text-neutral-100 shadow-elevated dark:border-neutral-700 dark:bg-black',
          className
        )}
        style={
          isCollapsed
